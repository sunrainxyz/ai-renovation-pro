...
if check_auth():
    with st.sidebar:
        ...
        style_list = {'原图风格': "Maintain original lighting.", '温馨暖调': "Warm lighting.", '清冷高级': "Cool modern."}
    ...
    with col1:
        ...
        if items_img:
            ...
            for i, f in enumerate(items_img):
...
st.markdown("---")
st.markdown("<p style='text-align: center; color: gray;'>观世不笑 · 2026 商业版 | 罗莱软装技术支持</p>", unsafe_allow_html=True)
